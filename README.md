...
- 💙~ My Software and OS : [`GNU/Linux - Ubuntu Desktop`](https://ubuntu.com/), [`Windows`](https://www.microsoft.com/fr-fr/windows/) for Gaming and [`GNU/Linux - Debian Server`](https://www.debian.org/) for my Server  - Ide : [`Intellij Idea`](https://www.jetbrains.com/fr-fr/idea/) and [`Visual Studio Code`](https://code.visualstudio.com/)
