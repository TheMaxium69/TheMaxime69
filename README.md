...
- 💙~ My Software and OS : [`GNU/Linux - Ubuntu Desktop`](https://ubuntu.com/), [`Windows`](https://www.microsoft.com/fr-fr/windows/) pour le Gaming et [`GNU/Linux - Debian Server`](https://www.debian.org/) pour mes Serveurs  - Ide : [`Intellij Idea`](https://www.jetbrains.com/fr-fr/idea/) Et [`Visual Studio Code`](https://code.visualstudio.com/)
